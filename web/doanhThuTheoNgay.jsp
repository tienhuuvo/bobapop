                ...
                <section class="mb-4" id="doanhThuThang">
                    <div class="card">
                        <div class="card-header py-3">
                            <h5 class="mb-0 text-center"><strong>Doanh thu theo ngày</strong></h5>
                        </div>
                        <div class="card-body">
        ...
        <script>// Graph
            ...
            new Chart(document.getElementById("verticalBar"), {
                ...
                "data": {
                    ...
                    "datasets": [{
                            "label": "Doanh thu $",
                            "data": [${totalMoneyDay2}, ${totalMoneyDay3}, ${totalMoneyDay4}, ${totalMoneyDay5}, ${totalMoneyDay6}, ${totalMoneyDay7}, ${totalMoneyDayCn}],
                            "fill": false,
